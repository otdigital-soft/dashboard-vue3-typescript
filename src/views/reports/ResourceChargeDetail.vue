  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      ...
      <div class="mt-2 sm:mt-0 sm:ml-16 sm:flex-none">
        ...
        <SaveReportNav :group-by="groupBy" :detail="true" @save-report="saveReport" />
      </div>
    </div>
    <div class="mt-14">
      <NonGroupView
...
const handleExport = async () => {
  ...
  await ReportApi.getResourceChargeFile(top.value, null, null, orderBy.value, orderValue, filtersValue, cols, "csv")
}
...
const handleView = async () => {
  ...
  const { data } = await ReportApi.getResourceCharges(top.value, null, null, orderBy.value, orderValue, filtersValue, cols)
