        ...
        <div class="w-full py-6 flex items-center justify-between border-b border-blue-500 lg:border-none">
          <div class="flex items-center">
            <a href="#">
              ...
              <img class="h-10 w-auto" src="/images/horizontal-logo.svg" alt="">
            </a>
            <div class="hidden ml-10 space-x-8 lg:block">
              <a
                ...
                :key="link.name"
                :href="link.href"
                class="text-base font-medium text-blue-500 hover:text-blue-900"
              >
                {{ link.name }}
              </a>
            </div>
          ...
          <div class="ml-10 space-x-4">
            ...
            <router-link
              to="/sign-in"
              class="inline-block bg-white py-2 px-4 border border-transparent rounded-md text-base font-medium text-blue-600 hover:bg-blue-50"
            >
              Sign
              in
            </router-link>
  ...
  <footer class="bg-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-400">
        &copy; 2022 CloudScope LLC. All rights reserved.
        Api url: {{ url }}
      </p>
    </div>
  </footer>
...
const url = ref("")
url.value = import.meta.env.VITE_CONCIERGE_API_ENDPOINT
