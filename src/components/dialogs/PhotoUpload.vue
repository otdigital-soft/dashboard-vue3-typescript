            ...
            >
              ...
              <div class="w-full">
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <DialogTitle
                    as="h3"
                    class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-200 flex mb-5 items-center"
                  >
                    <div
                      class="bg-blue-400 h-10 w-10 rounded-full align-center flex items-center justify-center mr-3"
                    >
                      <CloudArrowUpIcon
                  ...
                  <div ref="dropzoneInput" class="mt-2 w-full overflow-auto text-gray-500 dark:text-gray-200" style="max-height: 600px">
                    <form id="dropzoneForm" action="#" class="dropzone border-2 border-gray-300 dark:border-gray-600" />
                  </div>
                </div>
              </div>
...
const dropzoneOptions = {
  url: `${API_URL}/api/user/set-photo`,
  thumbnailWidth: 150,
  maxFilesize: 0.5,
