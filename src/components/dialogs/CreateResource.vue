            ...
            >
              <Form @submit="handleSubmit">
                ...
                <div class="sm:flex sm:items-start">
                  ...
                  >
                    <img :src="getResourceImage(selectedType)" class="h-6 w-6 text-blue-500" alt="">
                  </div>
                    ...
                    <div class="mt-2 text-sm text-gray-500 dark:text-gray-200">
                      ...
                      <TabGroup v-if="selectedType !== ''">
                        ...
                        <TabPanels class="pt-2">
                          <TabPanel>
                            <div v-for="key of Object.keys(commonResourceFields)" :key="key" class="mt-4">
                              <ResourceField
                                :field-key="key"
                          ...
                          <TabPanel>
                            <div v-for="key of Object.keys(customResourceFields)" :key="key" class="mt-4">
                              <ResourceField
                                :field-key="key"
...
import { ResourceTypes } from "@/models/serviceRequests/serviceRequestDetail"
import ResourceField from "../common/ResourceField.vue"
import ResourceFieldType from "@/models/resourceFieldType"
...
watch(selectedType, (newType) => {
  const allowedTypes = ["Analytics", "Blockchain", "Cloud", "Compute", "Container", "Database", "Devices", "Email", "Identity", "Infrastructure", "Network", "Other", "Security", "Software", "Storage", "Web"]

  if (allowedTypes.includes(newType)) {
    resourceFields.value = new ResourceTypes[newType]()
  }
})

const handleSubmit = () => {
  emit("create", resourceFields.value)
  selectedType.value = ""
