                  ...
                  <TabGroup>
                    ...
                    <TabPanels class="pt-2">
                      ...
                      <TabPanel>
                        ...
                        <div v-if="!isAddingComment" class="mt-5 divide-y-4">
                          <button
...
const deployedResource = ref<DeployedResource>(new DeployedResource())
...
const onSubmitResource = () => {
  if (!deployedResource.value.name || !deployedResource.value.resourceType || deployedResource.value.location === null) return false
  emit("created", deployedResource.value)
  deployedResource.value = new DeployedResource()
}
