...
const slackUrl = computed(() => {
  return `https://slack.com/oauth/v2/authorize?scope=app_mentions:read,reactions:write,chat:write,commands,team:read,im:write&client_id=947909996704.3471940278916&redirect_uri=${baseUrl.value}/oauth/slack/install`
})
