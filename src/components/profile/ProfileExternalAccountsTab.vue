...
const baseUrl = computed(() => {
  return window.location.href.replace(route.path, "")
})
const slackUrl = computed(() => {
  return `https://slack.com/oauth/v2/authorize?user_scope=users.profile:read&client_id=947909996704.3471940278916&redirect_uri=${baseUrl.value}/oauth/slack/link`
})
